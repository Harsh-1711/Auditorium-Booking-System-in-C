...
int booking_view()
{
    ...
    fp = fopen("C:\\Users\\Jarvis\\OneDrive\\Desktop\\Minor Project - Auditorium\\record.dat", "ab");
    if (fp == NULL)
    {
    ...
    while (1)
    {
        ...
        {
        case '1':
            fp = fopen("C:\\Users\\Jarvis\\OneDrive\\Desktop\\Minor Project - Auditorium\\record.dat", "rb+");
            log= fopen("C:\\Users\\Jarvis\\OneDrive\\Desktop\\Minor Project - Auditorium\\RequestLog.txt","a");
            if (fp == NULL)
            {
        ...
        case '4':{
            ...
            while (another == 'Y' || another == 'y')
            {
                ...
                scanf("%s", email);
                ft = fopen("C:\\Users\\Jarvis\\OneDrive\\Desktop\\Minor Project - Auditorium\\temp.dat", "wb");
                if(ft== NULL){
                    printf("Error creating temporary file.\n");
                    fclose(ft);
                }
                fp = fopen("C:\\Users\\Jarvis\\OneDrive\\Desktop\\Minor Project - Auditorium\\record.dat", "r");
                if (fp == NULL)
                {
                    puts("Cannot open file");
                    fclose(fp);
...
void login()
{
    ...
    while (a == 0)
    {
        ...
        fp = fopen("C:\\Users\\Jarvis\\OneDrive\\Desktop\\Minor Project - Auditorium\\credential.dat", "ab+");
        if (fp == NULL)
            {
...
void admin_view()
{
    ...
    while (a == 1)
    {
        ...
        case 3:{
            ...
            char name1[50];
            Booking b1;
            FILE *fp = fopen("C:\\Users\\Jarvis\\OneDrive\\Desktop\\Minor Project - Auditorium\\record.dat", "r+b");
            if (fp == NULL)
            {
            ...
            scanf("%s", name1);
            updateStatus(name1);
            FILE *log= fopen("C:\\Users\\Jarvis\\OneDrive\\Desktop\\Minor Project - Auditorium\\RequestLog.txt","a");
            if(log== NULL){
                puts("\nCannot open backup file");
                fclose(log);
                }
...
{
    Admin account;
    FILE *file = fopen("C:\\Users\\Jarvis\\OneDrive\\Desktop\\Minor Project - Auditorium\\credential.dat", "r+b");
    if (file == NULL)
    {
...
void updateStatus(char *name)
{
    ...
    Booking foundUser;
    int a = 0;
    FILE *file = fopen("C:\\Users\\Jarvis\\OneDrive\\Desktop\\Minor Project - Auditorium\\record.dat", "r+b");
    if (file == NULL)
    {
        printf("Error opening file\n");
        exit(1);
